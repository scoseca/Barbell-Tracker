...
if __name__ == "__main__":
    ...
    base_options = python.BaseOptions(model_asset_path="E:/Tesi/Barbel-Tracker/data/models/pose_landmarker_heavy.task")
    ...
    tracker = PoseTracker(pose_landmarker)
    tracker.analyze_video("E:/Tesi/Barbel-Tracker/data/raw_videos/dataset2/Video Mattia 2.mp4", "output_landmarker.mp4")