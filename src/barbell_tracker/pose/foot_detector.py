...
class FootPositionDetector:
    ...
    def extract_foot_positions_from_video(
        self,
        video_path,
        pose_landmarker,
        n_clusters=3,
        ...
        Args:
            ...
            plot_save_path: Percorso dove salvare il grafico dei cluster
        ...
        if visualize:
            ...
            # Salva il grafico
            plot_save_path = plot_save_path or 'foot_position_clusters.png'
            plt.savefig(plot_save_path, dpi=300, bbox_inches='tight')
            print(f"Grafico del clustering salvato come '{plot_save_path}'")
